...
def run():
    ...
    for event in events:
        ...
        for target_candidate in next_candidates:
            try:
                ...
                start_moment = approach_moments.iloc[0:10]
    ...
    print(f"Total failed candidates: {failed_candidates}")
    print(f"Total successful candidates: {successful_candidates}")